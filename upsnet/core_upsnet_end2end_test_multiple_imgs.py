...
#solo_img_path = "/home/zhiliu/Documents/catkin_ws_VoSM/outputs/test_images_for_panoptic_02022021/"
...
# *****************************************************************************************************
# prepare input data
all_images = glob(glob_path)

for i, img_path in enumerate(all_images):
    print("Processing image {} / {}".format(i + 1, len(all_images)))
    ...
    output_filename = join(output_path, input_filename)
